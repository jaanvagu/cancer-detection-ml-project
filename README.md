...
**Team Leader: [Jairo Andrés Valencia](https://github.com/jaanvagu)**
...
* Construction of a problem tree (causes and effects)
...
1. Clone this repo.
2. Raw data will be stored within this repository.
3. Data processing and analysis notebooks will be added progressively.
